...
if (-not (Test-Path (Join-Path $ProjectRoot "AsrService.csproj"))) {
    # Script might be run from the project root directly
...
Write-Host "  3. Open PowerShell in the extracted folder" -ForegroundColor White
Write-Host "  4. Run:  powershell -ExecutionPolicy Bypass -File Install.ps1" -ForegroundColor White
Write-Host ""
